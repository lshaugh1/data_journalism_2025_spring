...
**Task** Run the following code and describe the dataframe it outputs. **Answer** Links to press releases along with the text explaining what the URL contains.
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** It got rid of any repeating words.
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer** It removed all punctuation and made all text lowercase.
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer** It's not really interesting considering all of the most repeated unique words are just conjunctions or articles like "the". 
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer** Yes, it got rid of the common words. 
...
**Task** Run the following code and describe the results. **Answer** Baltimore and 'support' were high on the list, along with funding, million, county, funds, health, act, community and location. 
...
**Task** Run the following code and describe the results. **Answer** Gave us the top 10 bigrams, the number of them, and percentage of them. 
...
**Task** Run the following code and describe the results. **Answer** Top 10 two-word phrases for 2024 included health care, amount awarded, and purpose funds among others.
...
**Task** Run the following code and describe the differences between the two results. Which one might be more useful for the press release data? **Answer** Lemmatization could be more useful as it
converted all verb forms to the root verb "drive".
```{r}
...
**Task** Run the following code and describe the differences between the two results. Which one is more useful? **Answer** Unique_words_2024 had better and more consistent results.
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** Some words like "fight" do sound a little counter-intuitive. Some words can still be labeled as negative when used in a positive context.

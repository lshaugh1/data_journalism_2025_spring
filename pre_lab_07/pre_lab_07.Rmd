...
```{r echo=FALSE}
census_api_key("e39358220791c0a8a5da6688648920446535389c", install=TRUE)
```
...
Is the difference between Calvert and Montgomery significant? **Answer** No because the bars overlap so they aren't statistically significant.

Is the difference between Howard and everyone else significant? **Answer** Yes because it seems to be an outlier.
...
**Answer** 219 zip codes have estimated median household incomes of less than $50,000.
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer** What are the total populations and population densities of these counties and how long have residents been living in the county? In other words, have they just moved from a richer county to this one, raising the median household income? Or have they stayed in the county for several years and climbed income statuses?

```{r}
md_zips_with_acs <- md_zips_with_acs |>

...
A1: Bethesda (1177), Chevy Chase (704), Baltimore, Annapolis, Potomac, Silver Spring, Rockville
...
A3: I used ChatGPT for this question. Melanie is a self-employed farmer and seems to be married to Mark Jacobsen (same address), the second-highest donor who works in banking. Mark Jacobsen's name appears twice on the list, which leads me to believe there are some discrepancies in the data. Similarly, the Pugh's appear twice. 
